...
test(`Unsuccessful calculation of risk with empty fields returns 400`, async ({ request }) => {
  const order: Partial<ReturnType<typeof OrderDtoHw10.calculateRiskResultWithRandomData>> = {
    age: null,
    loanAmount: null,
    loanPeriod: null,
  }
