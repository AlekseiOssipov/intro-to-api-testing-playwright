export class LoanRiskCalculatorDto{
  income: number | null;
  debt: number | null;
  age: number | null;
  employed: boolean;
  ...
  static calculateRiskScoreWithRandomData(): LoanRiskCalculatorDto {
    ...
    return new LoanRiskCalculatorDto(income, debt, age, employed, loanAmount, loanPeriod);
  }

  static createOrderWithoutId() :undefined {
    return undefined
  }
}